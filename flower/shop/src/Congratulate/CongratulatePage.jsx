...
const CongratulateFlowersPage = () => {
  ...
  const currentItems = congratulateFlowerData.slice(indexOfFirstItem, indexOfLastItem);

  const paginate = (pageNumber) => {
    if (pageNumber >= 1 && pageNumber <= Math.ceil(congratulateFlowerData.length / itemsPerPage)) {
    ...
    <>
      ...
      <div className="congratulate-page">
        ...
        <Pagination
          ...
          totalItems={congratulateFlowerData.length}
          paginate={paginate}
...
export default CongratulateFlowersPage;
