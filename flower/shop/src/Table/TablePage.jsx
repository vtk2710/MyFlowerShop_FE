...
const TableFlowersPage = () => {
  ...
  const currentItems = tableFlowerData.slice(indexOfFirstItem, indexOfLastItem);

  const paginate = (pageNumber) => {
    if (pageNumber >= 1 && pageNumber <= Math.ceil(tableFlowerData.length / itemsPerPage)) {
    ...
    <>
      ...
      <div className="table-flowers-page">
        ...
        <Pagination
          ...
          totalItems={tableFlowerData.length}
          paginate={paginate}
...
export default TableFlowersPage;
