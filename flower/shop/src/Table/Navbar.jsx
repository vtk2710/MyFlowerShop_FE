      ...
      <header className="header">
        ...
        <nav className={`header__nav ${isMenuOpen ? "open" : ""}`}>
          <ul className="nav-list">
            ...
            <li><span className="disabled-link">BIRTHDAY FLOWERS</span></li>
            <li><span className="disabled-link">HOLIDAY FLOWERS</span></li>
            <li><span className="disabled-link">ORCHIDS</span></li>
            {/* TABLE FLOWER sẽ được highlight nếu đang ở trang /table */}
            <li><span className={location.pathname === "/table" ? "active-link" : "disabled-link"}>TABLE FLOWERS</span></li>
            <li>
              <UserOutlined
